...
#nullable restore
        ...
        public global::Zemires.N8n.Api.Models.WorkflowSettings_callerPolicy? CallerPolicy { get; set; }
...
#nullable restore
        ...
        public global::Zemires.N8n.Api.Models.WorkflowSettings_saveDataErrorExecution? SaveDataErrorExecution { get; set; }
        /// <summary>The saveDataSuccessExecution property</summary>
        public global::Zemires.N8n.Api.Models.WorkflowSettings_saveDataSuccessExecution? SaveDataSuccessExecution { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Zemires.N8n.Api.Models.WorkflowSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Zemires.N8n.Api.Models.WorkflowSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Zemires.N8n.Api.Models.WorkflowSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "callerPolicy", n => { CallerPolicy = n.GetEnumValue<global::Zemires.N8n.Api.Models.WorkflowSettings_callerPolicy>(); } },
                ...
                { "saveDataErrorExecution", n => { SaveDataErrorExecution = n.GetEnumValue<global::Zemires.N8n.Api.Models.WorkflowSettings_saveDataErrorExecution>(); } },
                { "saveDataSuccessExecution", n => { SaveDataSuccessExecution = n.GetEnumValue<global::Zemires.N8n.Api.Models.WorkflowSettings_saveDataSuccessExecution>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Zemires.N8n.Api.Models.WorkflowSettings_callerPolicy>("callerPolicy", CallerPolicy);
            ...
            writer.WriteEnumValue<global::Zemires.N8n.Api.Models.WorkflowSettings_saveDataErrorExecution>("saveDataErrorExecution", SaveDataErrorExecution);
            writer.WriteEnumValue<global::Zemires.N8n.Api.Models.WorkflowSettings_saveDataSuccessExecution>("saveDataSuccessExecution", SaveDataSuccessExecution);
